...
export default function AdminPage() {
  ...
  const [routeTemplates, setRouteTemplates] = useState<RouteTemplate[]>([
    {
      ...
      type: 'sequential',
      steps: [
        { approverId: 'user-2', approverName: 'Sarah Johnson', order: 1 },
        { approverId: 'user-4', approverName: 'Lisa Wong', order: 2 },
      ],
    },
  ]);
  ...
  const savePassword = () => {
    ...
    // In demo mode, just show success. In production, call API: PUT /api/users/:id/password
